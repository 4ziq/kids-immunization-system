                ...
                <div class="body table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            ?>
                            <tr>
                                <td scope="row" style="text-align: center"><?php echo $num++ ?></td>
                                <td><?php echo $name ?></td>
                                <td align=center><?php echo $ic ?></td>
                                <td align=center><?php echo $birthdate ?></td>
                                <td align=center><?php echo $gender ?></td>
                                <td align=center ><a href='?action=vaccine_record_detail&ic=<?php echo $ic ?>&name=<?php echo $name ?>'><button class="btn btn-info btn-extra-small">View Record</button></a></td>
                            </tr>
                            <?php
                                }
                            }else{
