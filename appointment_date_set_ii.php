                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    while($child_row = mysqli_fetch_array($child_result)){
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="?action=appointment_date_set_ii&ic=<?php echo $ic ?>&name=<?php echo $name ?>" style='text-decoration: none;'><button type='button' class='btn btn-block btn-primary'>Set Appointment</button></a></td>
