...
require_once('connection.php');
	...
	if(isset($_POST['Login']))
    {
       ...
       {
			$query="select staffIC, staffPassword from staff where staffIC='".$_POST['IC']."' and staffPassword='".$_POST['Password']."'";
			$result=mysqli_query($con,$query);

			if(mysqli_fetch_assoc($result))
			{
				session_start();
				$_SESSION['Staff']=$_POST['IC'];
				echo"<script> window.location.href='home_staff.php'</script>";
			}
			else
			{
            ...
            <div class="col-md-6 m-auto">
                ...
                <div class="card bg-light mt-3" style="border-radius: 10px;">
                    <div class="card-title text-white" style="border-radius: 10px 10px 0px 0px; background-color: #EA526F">
                        <h3 class="text-center py-3">Staff Login</h3>
                    </div>
